...
- **Fitness Chatbot Sidekick**: Got questions? The chatbot, powered by Google’s Gemini AI, dishes out expert tips on form, workouts, and more! 
...
This project is dual-licensed under the MIT License and the Apache License 2.0. You can choose either license to suit your needs! See the LICENSE file for full details.
